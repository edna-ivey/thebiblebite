    ...
    >
      ...
      <g aria-hidden="true">
        ...
        <path
          ...
          strokeWidth="2.8"
        />
        <ellipse cx="49" cy="43.5" fill="var(--ink)" rx="5.2" ry="6.4" />
        <ellipse cx="74" cy="43.5" fill="var(--ink)" rx="5.2" ry="6.4" />
        <circle cx="47.1" cy="41.4" fill="white" r="1.5" />
        <circle cx="72.1" cy="41.4" fill="white" r="1.5" />
        <path
